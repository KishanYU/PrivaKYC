...
const SuspiciousVerification = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="p-6">
        ...
        {verificationState === 'blocked' && (
          <div className="text-center py-6">
            ...
            <p className="text-gray-600 mb-6">This identity attempt has been blocked and logged to Snowflake & Backboard.io.</p>
      ...
      <div className="mt-8 space-y-8 px-6 pb-12">
        <div className="border-t border-gray-100 pt-8">
          <h3 className="text-lg font-bold text-gray-900 mb-6 flex items-center gap-2">
            <span className="w-1.5 h-6 bg-blue-600 rounded-full"></span>
            Real-time Sponsor Intelligence
          </h3>
